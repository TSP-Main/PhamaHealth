...
.banner_01 h6{font-size: 18px;margin:0 0 25px 0; color:#414040;font-weight: bold;}
...
<section class="treatment_options text-center treatment_options_mobile">
	...
	<div class="container">
		...
		<div class="reorder_medication" style="display: none;">For repeat request <a href="<?php echo URL?>patient/account/index.php?c=patient-prescriptions" id="id_medicine">Reorder Medication</a></div>
