   ...
   <div class="container"> 
				...
				<!-- 	<div class="commonly_product "> -->
					...
					{				
						...
						?>
						<div class="item">
							<div class="commonly_item" style="min-height:331px !important;border:2px solid #1C9CA0"  >

                            

                           <a href="javascript:;" class="openModalBtn" id="openCommon" data-modal-id="myModalCommon" data-id="<?php echo $rowCom['med_c_id']; ?>"><img src="<?php echo URL?>classes/timthumb.php?src=<?php echo URL?>images/medication/common/<?php echo $rowCom['med_c_image']; ?>&w=340&h=331&zc=1" style="min-height:100px" class="img-220px"></a>
...
<section class="simple_video text-center">
 ...
 <section class="faqs faqs_screen mpt-0">

 	<div class="container">

 		<div class="row none_mobile">
 	...
 	<div class="accordion mobile_accordion" style="display: none;" id="accordionExample3">
