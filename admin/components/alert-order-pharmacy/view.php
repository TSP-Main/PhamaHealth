						...
						<div class="card-body">
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
                                                ...
                                                <th width="17%" class="border-bottom-0">Order Date</th>
                                                <th width="13%" class="border-bottom-0">Order Approved by Clinician</th>
                                                <th width="14%" class="border-bottom-0">Clinician Name</th>
                                                <th width="14%" class="border-bottom-0">Pending Since</th>
							...
							?>				
								...
								<tr   >
                                    ...
                                    <td><?php echo displayDateTimeFormat($row['pres_date'])?></td>
									
                                    <td class="align-middle" >
                                    
                                   	<?php echo displayDateTimeFormat($row['pres_clincian_update']);?>
											
									</td>
                                    <td><a href="?c=prescribers&task=detail&id=<?php echo $row['pres_prescriber']; ?>" style="color:#06F; text-decoration:underline"><?php echo getUserNameByType('clinician',$row['pres_prescriber']); ?></a></td>
                                    <td><?php echo timeAgo($row['pres_clincian_update']);?></td>
