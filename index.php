...
<ul class="nav nav-tabs" id="myTab" role="tablist">
 ...
 <div class="tab-content" id="myTabContent">
  ...
  <input type="hidden" id="hdKeyword2" value="">
			...
			<div class="col-sm-6 d-none d-sm-inline-block d-lg-inline-block">
...
/* $('body').on('click', '.treatments_toggle', function(e) {
 	 $(".treatments_box").toggleClass("active");
    $('.treatments_box').find('.level-box').stop().slideUp();
    $(this).closest('.treatments_box').find('.level-box').stop().slideToggle();
});*/

$('body').on('click', '.treatments_toggle', function(e) { 
    var treatmentsBox = $(this).closest('.treatments_box');
    
    // Close other level boxes
    $('.treatments_box').find('.level-box').stop().slideUp();
    
    // Toggle the current level-box
    treatmentsBox.find('.level-box').stop().slideToggle();

    // Toggle the 'active' class on the current treatments_box
    treatmentsBox.toggleClass('active');
});
