								...
								<div class="sidebar-recent-news mb-60 lg-mb-40">
                                   ...
                                   <?php
									...
									<div class="news-block d-flex align-items-center pt-20 pb-20 border-top">
										<div><img src="<?php print URL;?>classes/timthumb.php?src=<?php echo URL?>images/blogs/<?php echo $BlogSide['blog_image']?>&w=180&h=80&zc=1" style="width: 180px; height: 80px; object-fit: cover; border-radius: 4px;"></div>
										<div class="post ps-4">
