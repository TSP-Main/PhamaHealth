				 ...
				 ?>
                     ...
                     <div class="form-group">
                         ...
                         <div class="w100p">
                            ...
                            <div class="radio_inline_box radio_button">
...
$strTextarea = '<span class="textarea_box">
    <textarea placeholder="Please provide more information" style="display:none; padding:10px; margin-left:10px; background-color: #fbfcfc; min-height: 180px; width:100%; border-radius: 2px; resize: none;" rows="3" cols="30" class="' . $textAreClass . '" name="txtMore_' . $rowQ['mq_id'] . '" id="txtMore_' . $rowQ['mq_id'] . '_' . $optIn . '"></textarea>
</span>';
						...
						<div><?php echo $strTextarea; ?></div>
                         ...
                         <ul class="conditions_list conditions_list_2">
...

							{
                             ...
                             <li>
                             	<label> <input class="form-check-input" name="ck_<?php echo $rowQ['mq_id']?>[]" id="ck_<?php echo $rowQ['mq_id']?>" type="checkbox" <?php if (in_array($optIn, $arrAskOptions)) { ?> onChange="openFreeText2('txtMore_<?php echo $rowQ['mq_id']?>_<?php echo $optIn; ?>',<?php echo $rowQ['mq_id']?>)" <?php } ?> value="<?php echo $arrOptions[$j]?>~~~<?php echo $arrRisk[$j]; ?>" role="switch"/>
                             		<div class="form_check_list">
                             	<?php echo $arrOptions[$j]?>
                             	</div>
